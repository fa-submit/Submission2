...
parser.add_argument('--root', default='../Lt-code/data/imagenet/', help='dataset setting')
parser.add_argument('--dataset', default='cifar100', help='dataset setting', choices=('cifar100', 'Imagenet-LT', 'iNat18', 'Places-LT', 'nih-cxr-lt')
)
...
parser.add_argument('--loss_type', default="CE", type=str, help='loss type / method', choices=('CE', 'LDAM', 'BS', 'EBS', 'Focal','IB','IBFocal','DBS', 'LAS','GCL'))
